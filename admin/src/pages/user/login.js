    ...
    login=()=>{
        ...
        userLogin(us,ps).then((res)=>{
            ...
            if(res.data.msg==='ok'){
                ...
                message.success('登陆成功,即将跳转至首页',1,()=>{
            ...
            <div className={style.login}>
                ...
                <div className={style.main}>
                    ...
                    title={this.state.logintype=='mgd'
                        ?<div className={style.logintype}><span  className={style.cardtitle}>蘑菇丁账号登录</span><span onClick={()=>{this.logintype('sm')}}>扫码登陆</span></div>
                        :this.state.logintype=='sm'?<div className={style.logintype}><span onClick={()=>{this.logintype('mgd')}}>蘑菇丁账号登录</span><span className={style.cardtitle} >扫码登陆</span></div>
